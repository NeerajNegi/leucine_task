...
@Component({
  selector: 'app-swab-form-cat2',
  templateUrl: './swab-form-cat2.component.html',
  styleUrls: ['./swab-form-cat2.component.scss']
})
export class SwabFormCat2Component implements OnInit {
